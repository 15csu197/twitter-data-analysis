...
ADD JAR /usr/lib/flume/lib/hive-serdes-1.0-SNAPSHOT.jar;
ADD JAR /home/sahil/Desktop/jason-1.3.10-sources.jar;
...
CREATE EXTERNAL TABLE Mytweets_raw (
   ...
   retweeted_status STRUCT<
      text:STRING,use:STRUCT<screen_name:STRING,name:STRING>>,
   entities STRUCT<
...
load data inpath '/flumedir/data/tweets_raw/FlumeData.1501314003070' INTO TABLE Mytweets_raw;
...
load data inpath '/flumedir/data/dictionary/dictionary.tsv' INTO TABLE dictionary;
...
load data inpath '/flumedir/data/time_zone_map/time_zone_map.tsv' INTO TABLE time_zone_map;
